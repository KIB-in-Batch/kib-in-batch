...
echo.
echo Welcome to KIB in Batch 10.0.1 ^(%PROCESSOR_ARCHITECTURE%^)
echo Booting system...
echo ------------------------------------------------
::                                                                 |
...
(
    ...
    echo ID=kibbatch
    echo ID_LIKE=linux
    echo VERSION_ID="10.0.1"
    echo PRETTY_NAME="KIB in Batch 10.0.1"
...
echo 10.0.1>"%APPDATA%\kib_in_batch\VERSION.txt"
